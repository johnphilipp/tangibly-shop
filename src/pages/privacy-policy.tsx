...
export default function PrivacyPolicyPage() {
  return (
    <Layout>
      <h1 className="mt-12 text-3xl">Privacy Policy</h1>
      ...
      <h2 className="mt-4 text-2xl">Interpretation and Definitions</h2>
      <h3 className="mt-4 text-xl">Interpretation</h3>
      <p>
      ...
      <h3 className="mt-4 text-xl">Definitions</h3>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Tangibly.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Tangibly, accessible from{" "}
            <a
              href="https://tangibly.me"
      ...
      <h2 className="mt-4 text-2xl">Collecting and Using Your Personal Data</h2>
      <h3 className="mt-4 text-xl">Types of Data Collected</h3>
      <h4 className="mt-4 text-lg">Personal Data</h4>
      <p>
      ...
      <h4 className="mt-4 text-lg">Usage Data</h4>
      ...
      <h4 className="mt-4 text-lg">Tracking Technologies and Cookies</h4>
      <p>
      ...
      <h3 className="mt-4 text-xl">Use of Your Personal Data</h3>
      ...
      <h3 className="mt-4 text-xl">Retention of Your Personal Data</h3>
      <p>
      ...
      <h3 className="mt-4 text-xl">Transfer of Your Personal Data</h3>
      <p>
      ...
      <h3 className="mt-4 text-xl">Delete Your Personal Data</h3>
      <p>
      ...
      <h3 className="mt-4 text-xl">Disclosure of Your Personal Data</h3>
      <h4 className="mt-4 text-lg">Business Transactions</h4>
      <p>
      ...
      <h4 className="mt-4 text-lg">Law enforcement</h4>
      <p>
        Under certain circumstances, the Company may be required to disclose
        Your Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </p>
      <h4 className="mt-4 text-lg">Other legal requirements</h4>
      <p>
      ...
      <h3 className="mt-4 text-xl">Security of Your Personal Data</h3>
      <p>
      ...
      <h2 className="mt-4 text-2xl">Links to Other Websites</h2>
      <p>
      ...
      <ul>
        <li>By email: contact@tangibly.me</li>
      </ul>
      <br />
      <br />
    </Layout>
