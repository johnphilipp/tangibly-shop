                ...
                <div className="mx-auto max-w-2xl py-24 lg:max-w-none lg:py-64">
                  <div className="lg:pr-16">
                    ...
                    <p className="mt-4 text-xl text-gray-600">
                      Let your runs, rides, hikes, and more shine in new light.
                      Visualize all your GPS-based Strava activities with
                      tangibly.
                    </p>
                    <div className="mt-6">
                      <a
